...
/**
 * list_tostrings - returns an array of strings of the list->str
...
/**
 * printing_list - prints all elements of a list_t linked list
 * @h: pointer to first node
 *
 * Return: size of list
 */
size_t printing_list(const list_t *h)
{
	size_t i = 0;

	while (h)
	{
		_puts(convert_numbering(h->num, 10, 0));
		_putchar(':');
		_putchar(' ');
